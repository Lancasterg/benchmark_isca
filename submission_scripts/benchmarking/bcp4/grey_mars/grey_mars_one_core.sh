...
#SBATCH --output=_grey_mars_one_core_%j.o
...
$HOME/.conda/envs/isca_env/bin/python $BENCHMARK_ISCA/scale/main.py -mincores 1 -maxcores 1 -r T21 -r T42 -r T85 -codebase grey_mars